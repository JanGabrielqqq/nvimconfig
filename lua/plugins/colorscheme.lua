    ...
    config = function()
      ...
      require("poimandres").setup({
        ...
        highlight_groups = {
          ...
          Search = { bg = p.blue2, fg = "#000000" },
          IncSearch = { bg = p.blue3, fg = "#000000" },
          ...
          Special = { fg = p.blue2 },
          htmlTagName = { fg = p.blue2 },
          LineNr = { fg = p.blueGray1 },
          CursorLineNr = { fg = p.blue3, bold = true },
          FloatBorder = { fg = p.blue2 },
          WinSeparator = { fg = p.blue1 },
          TroublePreview = { fg = p.blue1 },
          NormalFloat = { fg = p.white, bg = p.background2 },
          Pmenu = { fg = p.white, bg = p.background2 },
          PmenuSel = { fg = p.background1, bg = p.blue2, bold = true },
          Visual = { bg = p.blue2, fg = p.background1 },
          VisualNOS = { bg = p.blue2, fg = p.background1 },
          Title = { fg = p.blue3, bold = true },
          LspSignatureActiveParameter = { fg = p.background2, bg = p.blue1 },
          SnacksDashboardHeader = { fg = p.blue3 },
          SnacksDashboardFooter = { fg = p.blue2 },
          SnacksDashboardDesc = { fg = p.blue1 },
          SnacksDashboardKey = { fg = p.blue2 },
          SnacksDashboardIcon = { fg = p.blue3 },
